...
public class SendEmail {
    ...
    final String senderEmailID = "adingeist.ag@gmail.com";
    final String senderPassword = "ewhn swdd smxt sljp"; // Only works with Java applications. Will not grant access to my gmail.
    ...
    public void send(String receiverEmail, MimeMultipart emailBody) throws MessagingException {
        ...
        msg.setSubject("Niblet Verification Code"); // Subject of email
